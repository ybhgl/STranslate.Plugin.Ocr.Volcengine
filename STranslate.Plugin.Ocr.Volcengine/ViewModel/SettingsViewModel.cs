...
namespace STranslate.Plugin.Ocr.Volcengine.ViewModel;
...
public partial class SettingsViewModel : ObservableObject, IDisposable
{
    ...
    public async Task ValidateAsync()
    {
        try
        {
            ...
            var input = messages.Select(item => new
            {
                role = item.Role,
                content = new object[]
                {
            ...
            await _context.HttpService.PostAsync(uriBuilder.Uri.ToString(), content, option);
